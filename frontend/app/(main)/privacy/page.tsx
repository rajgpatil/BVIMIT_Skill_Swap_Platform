    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8 space-y-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-lg">Last updated: July 12, 2025</p>
        </div>
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8">Interpretation and Definitions</h2>
          <h3 className="text-xl font-semibold text-gray-900 mt-4">Interpretation</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-4">Definitions</h3>
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              <strong>Website</strong> refers to SkillSwap, accessible from{" "}
              <a href="https://skillswap.com" className="text-blue-600 hover:underline">
                https://skillswap.com
              </a>
            </li>
            <li>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8">Collecting and Using Your Personal Data</h2>
          <h3 className="text-xl font-semibold text-gray-900 mt-4">Types of Data Collected</h3>
          <h4 className="text-lg font-medium text-gray-900 mt-2">Personal Data</h4>
          <p>
          ...
          <h4 className="text-lg font-medium text-gray-900 mt-2">Usage Data</h4>
          ...
          <h4 className="text-lg font-medium text-gray-900 mt-2">Tracking Technologies and Cookies</h4>
          <p>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-4">Use of Your Personal Data</h3>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8">Retention of Your Personal Data</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8">Transfer of Your Personal Data</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8">Delete Your Personal Data</h2>
          <p>
          ...
          <p>
            Please note that We may need to retain certain information when we have a legal obligation or lawful basis
            to do so.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mt-8">Disclosure of Your Personal Data</h2>
          <h3 className="text-xl font-semibold text-gray-900 mt-4">Business Transactions</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-4">Law enforcement</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-4">Other legal requirements</h3>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8">Security of Your Personal Data</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8">Links to Other Websites</h2>
          <p>
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>By email: nilesh1234mete@gmail.com</li>
            <li>
              By visiting this page on our website:{" "}
              <a href="/contact" className="text-blue-600 hover:underline">
                https://skillswap.com/contact
              </a>
            </li>
          </ul>
        </div>
